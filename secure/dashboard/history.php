...
<html>
    <head>
	    <meta charset="UTF-8">
	    <title>History Pasien | Puskesmas Ketintang Barat</title>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light shadow mb-5 rounded">
        ...
        <div class="container">
            <div class="row h-100 justify-content-center align-items-center">
                <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 inputform">Histori Janji Temu "<?php echo htmlspecialchars($_SESSION["username"]); ?>"</h3>
                <?php
                    ...
                    $query = mysqli_query($conn, "SELECT * FROM pasien WHERE username_patient='$username'");
                ...
                <table class="table table-bordered bg-light box-shadow--16dp">
                    ...
                    <?php while ($row=mysqli_fetch_array($query)) {
                        ...
                        echo "<tr>
                            ...
                            <td>";
                                if ($row["status"] == "1"){ 
                                    echo '<button style="cursor:text;" type="button" class="btn btn-success">Sudah Diperiksa</button>';
                                }else{ 
                                    echo '<button style="cursor:text;" type="button" class="btn btn-danger">Belum Diperiksa</button>';
                                }
                            echo "</td>
		                </tr>";	
                    }
