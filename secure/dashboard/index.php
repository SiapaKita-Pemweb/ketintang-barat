...
<html>
    <head>
	    <meta charset="UTF-8">
	    <title>Menu Utama | Puskesmas Ketintang Barat</title>
                        ...
                        <a href="booking.php">
                            <div class="blockquote-box blockquote-primary clearfix">
                                ...
                                <h4>
                                    Buat janji temu</h4>
                                <p>
                                    Ingin bertemu dengan dokter? Buat janji untuk bertemu terlebih dahulu kepada dokter</a>
                                </p>
                            </div>
                        </a>
                        <a href="https://wa.me/+6282130040002">
                            <div class="blockquote-box blockquote-success clearfix">
                                ...
                                <h4>
                                    Hubungi Kami</h4>
                                <p>
                                    Hubungi layanan pelanggan kami jikalau Anda mengalami kendala terhadap layanan kami.
                                </p>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-6">
                        <a href="history.php">
                            <div class="blockquote-box blockquote-warning clearfix">
                                <div class="square pull-left">
                                    <i class="fa fa-history glyphicon-lg"></i>
                                </div>
                                <h4>
                                    Histori janji temu</h4>
                                <p>
                                    Lihat kembali histori aktivitas Anda bersama layanan kami.
                                </p>
                            </div>
                        </a>
                        <a onClick="return confirm('Anda yakin ingin menghapus akun? \nAnda akan kehilangan histori dan akses manfaat apapun.')" href="deleteaccount.php">
                            <div class="blockquote-box blockquote-danger clearfix">
                                <div class="square pull-left">
                                    <i class="fa fa-trash-o glyphicon-lg"></i>
                                </div>
                                <h4>
                                    Hapus Akun</h4>
                                <p>
                                    Histori dan manfaat akan hilang setelah Anda menghapus akun Anda.
                                </p>
                            </div>
                        </a>
                    </div>
