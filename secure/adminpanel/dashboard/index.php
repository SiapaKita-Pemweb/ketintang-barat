                        ...
                        <a href="periksa.php">
                            <div class="blockquote-box blockquote-primary clearfix">
                                <div class="square pull-left">
                                    <i class="fa fa-check-square-o glyphicon-lg"></i>
                                </div>
                                <h4>
                                    Periksa pasien</h4>
                                <p>
                                    Lakukan pemeriksaan dan ubah status pemeriksaan pasien disini
                                </p>
                            </div>
                        </a>
                    ...
                    <div class="col-md-6">
                        <a href="history.php">
                            <div class="blockquote-box blockquote-warning clearfix">
                                ...
                                <p>
                                    Cek semua riwayat janji temu yang dilakukan oleh pengguna.
                                </p>
                            </div>
                        </a>
                    </div>
