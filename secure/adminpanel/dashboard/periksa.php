...
<html>
    <head>
	    <meta charset="UTF-8">
	    <title>Periksa Pasien | Puskesmas Ketintang Barat</title>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light shadow mb-5 rounded">
        ...
        <div class="container">
            <div class="row h-100 justify-content-center align-items-center">
                <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 inputform">Periksa Pasien</h3>
                <?php
                ...
                <table class="table table-bordered bg-light box-shadow--16dp">
                    ...
                    <?php while ($row=mysqli_fetch_array($query)) {
                        ...
                        echo "<tr>
                            ...
                            <td>".$row["poli"]."</td>
                            <td>".$row["doctor"]."</td>
                            <td><a class='btn btn-outline-primary' href='ubahstatus.php?id=$row[id]'>Tandai Sudah Diperiksa</a></td>
		                </tr>";	
                    }
                    ?>
			        </tbody>
