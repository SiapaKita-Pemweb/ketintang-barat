...
<html>
	<head>
    <meta charset="UTF-8">
        <title>Login Page Staff | Puskesmas Ketintang Barat</title>
        ...
        <div class="custom container-fluid d-flex align-items-center justify-content-center">
            <div class="row bg-light form">
                <div class="col mt-3 col-xs-12 col-md-12 col-lg-12">
                    ...
                    <h1 style="text-align:center">Login Page Staff</h1><br>
                    <h2 style="text-align:center">Masuk dengan akun Anda</h2><br>
                    <h2 style="text-align:center; font-size:10pt;">(Hubungi bagian <a href="https://wa.me/6282130040002">SDM</a> jika ada kendala)</h2><br>
                    <?php 
                        if(!empty($login_err)){
